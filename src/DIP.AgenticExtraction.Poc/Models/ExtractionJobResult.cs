...
public record ExtractionJobResult
{
    ...
    /// <summary>
    /// Successful correction feedback collected during the correction loop.
    /// Key = field name, Value = list of feedback strings that led to successful re-extraction.
    /// Used for schema self-improvement — persisted back into final-schema.json as hints.
    /// </summary>
    public Dictionary<string, List<string>> SchemaFeedback { get; init; } = [];
